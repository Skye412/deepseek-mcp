 ...
 * Formats a code review prompt and extracts the response.
 */

import { BrowserManager } from '../browser-manager';
import { CodeReviewParams } from '../types';
 ...
 * @param params - Code review parameters containing code and optional language
...
export async function deepseekCodeReview(
  ...
  // Format the prompt for code review
